...
| M6.8 | Operational inbox | IN PROGRESS | 4/7 | M6.3–M6.5 | `application/inbox.py` + `application/inbox_store.py` + `api/routers/inbox.py` + `templates/inbox.html` + `tests/test_inbox_*.py`; 18-test bounded gate | Human-attention queue across agents, workflows, MCP |
