...
| M6.8 | Operational inbox | DONE | 7/7 | M6.3–M6.5 | `application/inbox.py` + `application/inbox_store.py` + `application/inbox_events.py` + `application/inbox_poc.py` + `api/routers/inbox.py` + `templates/inbox.html` + `tests/test_inbox_*.py`; 27-test bounded gate | Human-attention queue across agents, workflows, MCP |
...
| M7.2 | Board/column management + switcher | DONE | 6/6 | M7.1 |
| M7.3 | Live board updates over WebSocket | DONE | 5/5 | M7.1 |
